...
/**
 * WebSecurityConfigurerAdapter - to access authentication manager
 */
...
public class AuthServerConfiguration extends WebSecurityConfigurerAdapter implements AuthorizationServerConfigurer {
    ...
    public void configure(ClientDetailsServiceConfigurer clientDetailsServiceConfigurer) throws Exception {
        clientDetailsServiceConfigurer.inMemory().withClient("root")
                .secret(passwordEncoder().encode("toor"))
